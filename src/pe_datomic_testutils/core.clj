...
(defn make-db-refresher-fixture-fn
  ...
  it, and then transacts the set of given schema files and transacts the given
  partition (creates it).  Like any test fixture function, the returned function
  receives as its input a function, and invokes it."
